          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  flex: 1,
                  child: _buildAdminTextField("CTN", ctnCtrl, isNumber: true),
                ),
                const SizedBox(width: 12),
                Expanded(
                  flex: 2,
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  setState(() {
                    tempRecords.add({
                      "refCode": refCtrl.text,
                      "jkCode": jkCtrl.text,
                      "ctn": ctnCtrl.text,
                      "tracking": trackingCtrl.text.isEmpty
                          ? "-"
                          : trackingCtrl.text,
                    });
                    refCtrl.text = "TPS";
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Padding(
                        ...
                        child: Text(
                          "${item['ctn']} CTN | Tracking: ${item['tracking']}",
                          style: const TextStyle(
                            color: Colors.white54,
                            fontSize: 12,
                          ),
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () =>
                            setState(() => tempRecords.removeAt(index)),
                      ),
                    );
                  },
                ),
                          ...
                          if (response.statusCode == 201 ||
                            ...
                            if (mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('บันทึกข้อมูลสำเร็จเรียบร้อย'),
