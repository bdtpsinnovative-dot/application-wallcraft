...
class _PoolFilterSheetState extends State<PoolFilterSheet> {
  ...
  IconData _getIconForProjectType(String? projectTypeName) {
    ...
    if (projectTypeName.contains('Shopping Mall'))
      return Icons.shopping_bag_rounded;
    if (projectTypeName.contains('Hospital'))
      return Icons.local_hospital_rounded;
    if (projectTypeName.contains('Private Resident')) return Icons.home_rounded;
    if (projectTypeName.contains('Office Building'))
      return Icons.business_rounded;
    if (projectTypeName.contains('Housing Estate'))
      return Icons.cottage_rounded;
    if (projectTypeName.contains('Resort'))
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildFilterSection(
                    ...
                    selectedOptions: tempDateRange.isNotEmpty
                        ? [tempDateRange]
                        : [],
                    onSelect: (val) {
                      setState(() {
                        if (tempDateRange == val)
                          tempDateRange = '';
                        else
                          tempDateRange = val;
                      });
                  ...
                  _buildFilterSection(
                    ...
                    onSelect: (val) {
                      setState(() {
                        if (tempProjectTypes.contains(val))
                          tempProjectTypes.remove(val);
                        else
                          tempProjectTypes.add(val);
                      });
                    },
                  ),
                  const SizedBox(height: 24),
                  ...
                  _buildFilterSection(
                    ...
                    onSelect: (val) {
                      setState(() {
                        if (tempSaleNames.contains(val))
                          tempSaleNames.remove(val);
                        else
                          tempSaleNames.add(val);
                      });
                    },
                  ),
                  const SizedBox(height: 24),
                  ...
                  _buildFilterSection(
                    ...
                    onSelect: (val) {
                      setState(() {
                        if (tempAreaRanges.contains(val))
                          tempAreaRanges.remove(val);
                        else
                          tempAreaRanges.add(val);
                      });
                    },
                  ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      widget.onApply({
                        ...
                        'isImportant':
                            tempIsImportant, // 🌟 ส่งค่ากลับไปหน้าหลัก
                      });
